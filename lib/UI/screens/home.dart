            ...
            onCardSwiped: (dir, index, widget) {
              ...
              if (counter <= 20) {
                ...
                _cardController.addItem(spark_card(context,
                    "https://images.unsplash.com/photo-1583147610149-78ac5cb5a303?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", name));
                counter++;
              }
